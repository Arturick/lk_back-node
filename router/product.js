...
let type = upload.any();
router.post("/find-by-article", authMiddleware,  roleMiddleware.secondRole, controller.findByArticle);
router.get("/get-report", authMiddleware,  controller.findByArticle);
router.post("/find-by-articles", authMiddleware,  roleMiddleware.secondRole,  controller.findByArticles);
router.post("/find-position", authMiddleware,  roleMiddleware.secondRole,  controller.findPosition);
router.post("/buyout", authMiddleware,  controller.getBuyout);
router.post("/draft", authMiddleware,  controller.getDraft);
router.post("/update-draft", authMiddleware,  roleMiddleware.secondRole,  controller.updateDraft);
...
router.post("/save-draft", authMiddleware, roleMiddleware.secondRole,  controller.draftSave);
router.post("/get-by-api", authMiddleware,  controller.getProductByApi);
router.post("/save", authMiddleware,  roleMiddleware.secondRole,  controller.save);
...
router.post("/update-review", authMiddleware,  roleMiddleware.secondRole,  controller.setReview);
router.post("/parse-excel", type,  roleMiddleware.secondRole,  controller.parseExcel);
...
router.post("/update-profile", authMiddleware,  roleMiddleware.secondRole, user.updateProfile);
